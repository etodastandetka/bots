...
try:
    ...
    API_CONFIG = {
        "api_key": "d6ad6a2a6a578d10a47d475eb8475ed60337d96e8b3d157d285ce3328320de76",  # API ключ Melbet
        "deposits_blocked": False  # Разрешаем пополнения для Melbet
    }
...
BOT_NAME = "melbet"  # Изменено на melbet
BOT_SOURCE = "melbet"  # Идентификатор бота для API
...
WITHDRAWAL_GROUP_ID = -4925478400  # Группа для заявок на вывод MELBET
DEPOSIT_GROUP_ID = -4840431928     # Группа для заявок на пополнение MELBET
...
def temp_removed_admin_function3():
    ...
    try:
        conn = sqlite3.connect('melbet.db')
        cursor = conn.cursor()
...
translations = {
    'ru': {
        ...
        'enter_id': "🆔 Отправьте ID вашего счета Melbet",
        ...
        'enter_1xbet_id': "Введите ID вашего счета Melbet",
        ...
        'enter_account_id': "Введите ID вашего счета Melbet:",
        ...
        'enter_account_id_prompt': "📱 Введите ID вашего счета Melbet:",
        'example_id_title': "",
        'find_id_instruction': "",
        ...
        'enter_1xbet_id_withdraw': "Введите ID Melbet:",
    ...
    'ky': {
        ...
        'enter_id': "🆔 Melbet эсебиңиздин ID'син жөнөтүңүз",
...
class Database:
    def __init__(self, db_path: str = 'melbet_bot.db'):
    ...
    def init_db(self):
        ...
        CREATE TABLE IF NOT EXISTS user_ids (
            ...
            user_id INTEGER,
            xbet_id TEXT,
            bot_source TEXT DEFAULT 'melbet',
    ...
    def set_user_xbet_id(self, user_id: int, xbet_id: str, bot_source: str = 'melbet'):
    ...
    def add_user_xbet_id(self, user_id: int, xbet_id: str, bot_source: str = 'melbet'):
        """Добавить новый ID для пользователя (для обратной совместимости)"""
        self.set_user_xbet_id(user_id, xbet_id, bot_source)
    
    def get_user_xbet_id_single(self, user_id: int, bot_source: str = 'melbet') -> Optional[str]:
    ...
    def get_user_xbet_ids(self, user_id: int, bot_source: str = 'melbet') -> List[str]:
    ...
    def remove_user_xbet_id(self, user_id: int, xbet_id: str, bot_source: str = 'melbet'):
    ...
    def set_user_phone(self, user_id: int, phone: str, bot_source: str = 'melbet'):
    ...
    def get_user_phone(self, user_id: int, bot_source: str = 'melbet') -> Optional[str]:
...
class OneWinAPI:
    def __init__(self):
        self.base_url = "https://api.melbet.win"
        self.api_key = None
        self.session = None
    
    def set_api_key(self, api_key: str):
        """Установка API ключа для Melbet"""
        ...
        try:
            ...
            async with session.post(
                ...
                if response.status == 200:
                    ...
                    logger.error(f"Melbet API deposit error: {response.status} - {error_text}")
                    return None
                    
        except Exception as e:
            logger.error(f"Melbet API deposit exception: {e}")
            return None
        ...
        try:
            ...
            async with session.post(
                ...
                if response.status == 200:
                    ...
                    error_text = await response.text()
                    logger.error(f"Melbet API withdrawal error: {response.status} - {error_text}")
                    return None
                    
        except Exception as e:
            logger.error(f"Melbet API withdrawal exception: {e}")
            return None
...
async def replenish(message: types.Message, state: FSMContext):
    ...
    if saved_xbet_id:
        ...
        try:
            ...
            photo = FSInputFile("images/melbet-id.jpg")
